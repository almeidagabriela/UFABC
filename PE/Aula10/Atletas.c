...
int main(){
    int idades[QUANTIDADE], i, qtdMasc = 0, qtdFem = 0, qtdMascAcimaAltMedia = 0, qtdFemAbaixoPesoMedio = 0;
    ...
    for(i = 0; i < QUANTIDADE; i++){
        ...
        scanf("%f", &alturas[i]);
        scanf("%f", &pesos[i]);
        scanf("\n%c", &generos[i]); // Utilizamos o \n para consumir o enter e não dar problema no buffer
